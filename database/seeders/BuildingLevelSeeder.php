...
class BuildingLevelSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            [
                [5, 0, 1000, 0, 0, 0, 0, 'storage'],
                [5, 1, 2000, 0, 0, 0, 0, 'storage'],
                [5, 2, 4000, 0, 0, 0, 0, 'storage'],
                [5, 3, 8000, 0, 0, 0, 0, 'storage'],
                [5, 4, 16000, 0, 0, 0, 0, 'storage'],
                [5, 5, 32000, 0, 0, 0, 0, 'storage'],
                [5, 6, 64000, 0, 0, 0, 0, 'storage'],
                [5, 7, 128000, 0, 0, 0, 0, 'storage'],
                [5, 8, 256000, 0, 0, 0, 0, 'storage'],
                [5, 9, 512000, 0, 0, 0, 0, 'storage'],
            ],

            // Valores para building_id = 5
            [
                [6, 0, 0, 1000, 0, 0, 0, 'storage'],
                [6, 1, 0, 2000, 0, 0, 0, 'storage'],
                [6, 2, 0, 4000, 0, 0, 0, 'storage'],
                [6, 3, 0, 8000, 0, 0, 0, 'storage'],
                [6, 4, 0, 16000, 0, 0, 0, 'storage'],
                [6, 5, 0, 32000, 0, 0, 0, 'storage'],
                [6, 6, 0, 64000, 0, 0, 0, 'storage'],
                [6, 7, 0, 128000, 0, 0, 0, 'storage'],
                [6, 8, 0, 256000, 0, 0, 0, 'storage'],
                [6, 9, 0, 512000, 0, 0, 0, 'storage'],
            ],

            // Valores para building_id = 7
            [
                [7, 0, 1000, 1000, 0, 0, 0, 'storage'],
                [7, 1, 2000, 2000, 0, 0, 0, 'storage'],
                [7, 2, 4000, 4000, 0, 0, 0, 'storage'],
                [7, 3, 8000, 8000, 0, 0, 0, 'storage'],
                [7, 4, 16000, 16000, 0, 0, 0, 'storage'],
                [7, 5, 32000, 32000, 0, 0, 0, 'storage'],
                [7, 6, 64000, 64000, 0, 0, 0, 'storage'],
                [7, 7, 128000, 128000, 0, 0, 0, 'storage'],
                [7, 8, 256000, 256000, 0, 0, 0, 'storage'],
                [7, 9, 512000, 512000, 0, 0, 0, 'storage'],
            ],
